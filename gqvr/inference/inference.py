...
# TODO: implement atleast 2 captioners: LLava-NeXT, DAPE
...
class InferenceLoop:
    ...
    def load_cldm(self) -> None:
        ...
        if self.args.version == "v1":
            control_weight = load_model_from_url(MODELS["v1"])
    ...
    def load_lq(self) -> Generator[Image.Image, None, None]:
        ...
        assert os.path.isdir(
            self.args.input
        ), "Please put your 3-bit SPC images in a folder."
