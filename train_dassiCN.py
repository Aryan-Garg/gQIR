...
def main(args) -> None:
    ...
    set_seed(310, device_specific=True)
    ...
    sampler = DPMSolverSampler(
        diffusion.betas, diffusion.parameterization, rescale_cfg=False, model_spec="dpm++_m2"
    )
    if accelerator.is_main_process:
    ...
    while global_step < max_steps:
        ...
        for batch in loader:
            ...
            with torch.no_grad():
                ...
                clean = pure_cldm.vae_decode(pure_cldm.vae_encode(lq))
