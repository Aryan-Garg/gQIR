...
from gqvr.model.vae import AutoencoderKL, ConvEMA_Decoder, ConvEMA_AutoencoderKL
...
def reset_decoder_memory(decoder: ConvEMA_Decoder):
    decoder.ema_mem_block1_stab = None
    decoder.ema_mem_block1_unstab = None
    decoder.ema_mem_block2_stab = None
    decoder.ema_mem_block2_unstab = None
    decoder.ema_mem_convout_stab = None
